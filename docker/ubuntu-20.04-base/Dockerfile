...
# docker build -f Dockerfile -t registry.fizzyade.com/ubuntu-20.04-base .
# docker save registry.fizzyade.com/ubuntu-20.04-base | gzip > ubuntu-20.04-base.tar.gz
# docker import ubuntu-20.04-base.tar.gz
