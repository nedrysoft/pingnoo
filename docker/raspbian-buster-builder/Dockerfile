...
# docker build -f Dockerfile -t registry.fizzyade.com/raspbian-buster-builder .
# docker save registry.fizzyade.com/raspbian-buster-builder | gzip > raspbian-buster-builder.tar.gz
# docker import raspbian-buster-builder.tar.gz
# docker push registry.fizzyade.com/raspbian-buster-builder

FROM registry.fizzyade.com/raspbian-buster-base
