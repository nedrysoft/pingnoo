...
#ifndef PINGNOO_COMPONENTS_ICMPAPIPINGENGINE_ICMPAPIPINGITEM_H
#define PINGNOO_COMPONENTS_ICMPAPIPINGENGINE_ICMPAPIPINGITEM_H
...
#endif // PINGNOO_COMPONENTS_ICMPAPIPINGENGINE_ICMPAPIPINGITEM_H
