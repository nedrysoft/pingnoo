...
# docker build -f Dockerfile -t registry.fizzyade.com/fedora-33-builder .
# docker save registry.fizzyade.com/fedora-33-builder | gzip > fedora-33-builder.tar.gz
# docker import fedora-33-builder.tar.gz
